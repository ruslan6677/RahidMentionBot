...
async def handler(event):	
    await event.edit(f"**📌 [Rahid Tag Bot](http://t.me/Rahid_Tag_Bot)-un təkliflər üçün sahib'lə əlaqə saxlaya bilərsiniz...**", buttons=(
